<template>
  <v-container >
    ...
    <p class="pe-text">
      Algo que me fascina, pelo menos desde a adolescência é o cinema antigo:
      Film Noir, Orson Welles, Alfred Hitchcock, Martin Scorcese, dêem-me todos os dias uma obra de um destes realizadores em vez
    ...
    Talvez por ser monocromático ou pelas paisagens rurais, mas isso são apenas semelhanças com o outro realizador e não algo que tenha especificamente contra o filme (sim, tipo... passa-se sobretudo no meio rural, vou lhe dar 2/5, teria sido melhor a acção desenrolar-se num subúrbio numa selva de asfalto.. ). <br>
    ...
    Do que vi até agora do Rainer é isto que vos posso contar: Este realizador tinha uma certa predilecção e uma capacidade fantástica para retratar e elevar a disfuncionalidade nas relações amorosas. <br>
  ...
  <br>
    ...
    De todas as personagens a que me irá ficar mais na memória (e aposto que também na vossa) é a Petra Von Kant, personagem principal do filme homónimo <b>The Bitter Tears of Petra Von Kant (1972)</b> e mais não digo (VEJAM O FILME). <br>
    ...
    <i>"Yes, I seem to be, what I'm not you see <br>

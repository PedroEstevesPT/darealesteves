  ...
  data: () => ({
    ...
    photos:  [
      ...
      },
      {
        ...
        "description": { 
          "pt":  "Cerveja japonesa. Agradável, não tão diferente das portuguesas.",
          "en": "Japonese beer, tasty, not to different from the portuguese ones."
        }
      }
    ]
  }),
